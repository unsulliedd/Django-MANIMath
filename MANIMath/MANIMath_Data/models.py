...
class FunctionModel(models.Model):
    ...
    x_range = models.CharField(max_length=16 ,blank=True, null=True, default="-5,5,1")
    y_range = models.CharField(max_length=16, blank=True, null=True, default="-5,5,1")
    x_length = models.IntegerField(blank=True, null=True, default=8)
    y_length = models.IntegerField(blank=True, null=True, default=6)
    domain = models.CharField(max_length=16, blank=True, null=True, default="-5,5,1")
    ...
    axes_color = models.CharField(max_length=32, blank=True, null=True, default="#ffffff")
    line_color = models.CharField(max_length=32, blank=True, null=True, default="#FF0000")
    shape_color = models.CharField(max_length=32, blank=True, null=True, default="#FFFF00")
...
class RootFindingModel(models.Model):
    ...
    axes_color = models.CharField(max_length=32, blank=True, null=True, default="#ffffff")
    line_color = models.CharField(max_length=32, blank=True, null=True, default="#FF0000")
    tangent_color = models.CharField(max_length=32, blank=True, null=True, default="#008000")
    shape_color = models.CharField(max_length=32, blank=True, null=True, default="#FFFF00")
    scale = models.FloatField(blank=True, null=True, default=1)
    include_tip = models.BooleanField(default=False)
    include_numbers = models.BooleanField(default=False)
